      ...
      <section className="py-16 bg-black/5">
        <div className="container mx-auto px-4">
          ...
          <Link href="/galleries/world-through-my-lens">
            <button className="cta-button mb-8 px-6 py-3 rounded-full bg-accent text-white hover:bg-[var(--color-accent-hover)] transition-colors flex items-center gap-2">
