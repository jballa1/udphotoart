...
const regionMap = {
  ...
  'Cusco, Perú': { region: 'Peru', state: 'Peru', description: 'Ancient Incan capital heritage' },
  ...
  'Sacred Valley, Perú': { region: 'Peru', state: 'Peru', description: 'Heart of the Incan empire' },
